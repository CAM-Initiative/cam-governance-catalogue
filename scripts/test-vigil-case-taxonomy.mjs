...
assert.match(reportCss, /\.report-external-assessment-table \{[\s\S]*font-size: 0\.88rem;/);
assert.match(reportCss, /@media print \{[\s\S]*\.report-external-assessment-table,[\s\S]*font-size: 11pt !important;/);
