...
export default function VigilAbout() {
  return <Shell><VigilObservatoryNav /><main className="vigil-about-page"><div className="container mx-auto max-w-[1220px] px-4 py-8 sm:px-6 md:px-10 md:py-11">
    ...
    <section className="vigil-about-section" aria-labelledby="vigil-severity-heading">
      ...
      <p className="vigil-about-record-intro">The reference matrix below shows the canonical <strong>VIGIL-HIM 1.0.0</strong> threshold criteria for every harm dimension and every S1–S5 band. This is the methodology view: it explains what would qualify for each cell rather than implying that every cell applies to a particular Incident.</p>
      <HarmImpactMatrix />
      <p id="vigil-severity-caption" className="vigil-about-note"><strong>In Case Files:</strong> the full reference matrix is replaced by the occurrence-specific evidence state, supported band, threshold ID and assessment basis for each dimension. Any dimension controlling the overall severity is identified explicitly.</p>
      <p className="vigil-about-note"><strong>Evidence-to-repair sequence:</strong> observed incident → incident evidence → observed consequences or harms → VIGIL severity assessment → AI failure mechanism classification → invariant or governance repair.</p>
