...
export default function VigilAbout() {
  return <Shell><VigilObservatoryNav /><main className="vigil-about-page"><div className="container mx-auto max-w-[1220px] px-4 py-8 sm:px-6 md:px-10 md:py-11">
    ...
    <section className="vigil-about-section" aria-labelledby="vigil-taxonomy-heading">
      ...
      <p className="vigil-about-note"><strong>Use and authority:</strong> VIGIL Observatory documents, diagnoses and classifies AI governance failure mechanisms from available evidence using explicit classification criteria and a maintained taxonomy. Its findings are designed to support technical, governance, regulatory, contractual and legal analysis, with the underlying evidence and reasoning available for independent review. VIGIL&apos;s authority is analytical rather than institutional: it may reach conclusions relevant to disputed legal or governance questions, while any binding legal, regulatory or institutional consequence remains with the relevant authorised decision-maker.</p>
