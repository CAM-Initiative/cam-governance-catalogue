            ...
            >
              <div className="border-b border-cam-gold/30 bg-[hsl(36_48%_96%)] px-6 py-5 md:px-8">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  <span className="rounded-full border border-primary/20 bg-card/70 px-3 py-1 font-mono text-[10px] font-semibold uppercase tracking-[0.14em] text-foreground/65">
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  ...
                  <a
                    className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-primary/30 bg-card/70 px-5 py-3 text-sm font-semibold text-foreground transition hover:border-primary/55 hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                    href={policyPdfHref}
                    rel="noreferrer"
                    target="_blank"
                  >
              ...
              <aside className="border-t border-cam-gold/30 bg-[hsl(36_48%_96%)] p-6 md:p-8" aria-label="Publication details">
                <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
                  <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em] text-cam-gold">Publication details</p>
                  <CitationCopyButton />
                </div>
                ...
                <dl className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                  ...
                  <div className="rounded-xl border border-border/80 bg-card/70 p-4">
                    <dt className="font-mono text-[10px] font-semibold uppercase tracking-[0.14em] text-foreground/50">Published</dt>
                  ...
                  <div className="rounded-xl border border-border/80 bg-card/70 p-4 md:col-span-2 xl:col-span-3">
                    <dt className="font-mono text-[10px] font-semibold uppercase tracking-[0.14em] text-foreground/50">Submitted to</dt>
                    <dd className="mt-1 text-sm leading-relaxed text-foreground">Australian Government policy contacts, including the Office of AI and the Attorney-General’s Department.</dd>
                  </div>
                  <div className="rounded-xl border border-border/80 bg-card/70 p-4 md:col-span-2 xl:col-span-3">
                  ...
                  <div className="rounded-xl border border-border/80 bg-card/70 p-4 md:col-span-2 xl:col-span-3">
                    ...
                    <dd className="mt-2 font-mono text-xs leading-relaxed text-foreground/80">{suggestedCitation}</dd>
                  </div>
                </dl>
              </aside>
            </motion.article>
