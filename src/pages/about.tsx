    ...
    <main className="vigil-about-page">
      <div className="container mx-auto max-w-[1220px] px-4 py-8 sm:px-6 md:px-10 md:py-11">
        ...
        <section className="vigil-about-section" aria-labelledby="vigil-method-heading">
          ...
          <p className="vigil-about-note">A reported incident is not automatically a new failure class. VIGIL Observatory asks what mechanism failed, whether that mechanism is already represented in the taxonomy, and what the available evidence actually supports.</p>
        </section>

        <section className="vigil-about-section" aria-labelledby="vigil-taxonomy-heading">
          <div className="vigil-about-section-heading"><p className="vigil-library-kicker">VIGIL Observatory Failure Taxonomy</p><h2 id="vigil-taxonomy-heading">Failure families organise the landscape. Failure classes identify the mechanism.</h2></div>
          ...
          <p className="vigil-about-note"><strong>Classification boundary:</strong> source terminology remains source terminology unless it is explicitly identified as a VIGIL Observatory classification. The Case File preserves the evidence and reasoning used to make that distinction independently reviewable.</p>
        ...
        <section className="vigil-about-section" aria-labelledby="vigil-citation-heading">
          ...
          <p className="vigil-about-note">For a specific Incident or taxonomy entry, identify the relevant VIGIL Observatory record ID or taxonomy version and use the canonical URL. Citation, reference and linking are permitted; substantive reuse is governed by the applicable licence.</p>
        </section>
        </article>
      </div>
    </main>
