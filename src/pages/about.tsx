      ...
      <div className="container mx-auto max-w-[1220px] px-4 py-8 sm:px-6 md:px-10 md:py-11">
        ...
        <article className="vigil-about-document">
          <section className="vigil-about-section" aria-labelledby="vigil-method-heading">
            ...
            <p className="vigil-about-record-intro">The Case File structure keeps what happened separate from occurrence-level assessment and severity, taxonomy classification, any governing invariant that a failure requires repair to restore, and the references supporting those conclusions.</p>
            <p className="vigil-about-record-intro">A reported occurrence is not automatically a failure, and a failure is not automatically a new class. VIGIL Observatory asks what the evidence establishes, which taxonomy boundary is relevant, and whether that relationship represents a failure occurrence or an example of the governing invariant holding successfully.</p>
          ...
          <section className="vigil-about-section" aria-labelledby="vigil-taxonomy-heading">
            ...
            <div className="vigil-about-boundary-grid">
              ...
              <article><h3>Failure occurrence</h3><p>The evidence supports the class mechanism occurring in the Case File. Where a class invariant is published, Repair identifies the condition that must be restored.</p></article>
              <article><h3>Successful-invariant exemplar</h3><p>The occurrence sits on the successful side of the same class boundary: the relevant invariant held under pressure. It remains visible for comparison without being presented as a failure.</p></article>
            </div>
