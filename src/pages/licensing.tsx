...
const licensingRail = [
  { href: "#ownership", label: "Publisher, author and licensor" },
  { href: "#vigil-materials", label: "VIGIL Observatory materials" },
  { href: "#licence-instrument", label: "Licence instrument" },
  { href: "#third-party-sources", label: "Third-party sources" },
  { href: "#permissions", label: "Permissions" },
  { href: "#citation", label: "Suggested citation" },
];

function ReferenceSection({ id, number, eyebrow, title, children }: { id: string; number: string; eyebrow: string; title: string; children: ReactNode }) {
  return <section id={id} className="document-section public-reference-section">
...
function CopyCitation() {
  ...
  return <button className="cam-action cam-action-secondary cam-action-compact" type="button" onClick={copy} aria-label="Copy VIGIL Observatory citation">
...
export default function Licensing() {
  return <Shell>
    <main className="public-reference-page public-reference-page--single-document home-menu-page document-page">
      <div className="document-layout">
        <DocumentRail title="Copyright & Licence" items={licensingRail} ariaLabel="Copyright and licence sections" />

        <article className="document-content public-reference-document public-reference-document--single">
          <header className="document-hero public-reference-hero">
            ...
            <p>Public access supports inspection, citation, research reference and public-interest discussion. It does not make VIGIL Observatory or other CAM Initiative materials open-licensed.</p>
            <p className="public-reference-meta">© 2026 CAM Initiative. All rights reserved.</p>
          </header>

          <ReferenceSection id="ownership" number="01" eyebrow="Ownership" title="Publisher, author and licensor">
          ...
          <ReferenceSection id="licence-instrument" number="03" eyebrow="Licence instrument" title="VIGIL Observatory Proprietary Licence">
            <div className="public-reference-reading">
          ...
          <ReferenceSection id="third-party-sources" number="04" eyebrow="Third-party sources" title="Source material keeps its own rights">
            <div className="public-reference-reading">
          ...
          <ReferenceSection id="permissions" number="05" eyebrow="Permissions" title="Licence enquiries">
            <div className="public-reference-reading">
          ...
          <ReferenceSection id="citation" number="06" eyebrow="Citation" title="Suggested general citation">
            <div className="public-reference-reading">
