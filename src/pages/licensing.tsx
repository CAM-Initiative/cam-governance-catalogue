...
export default function Licensing() {
  return <Shell><main className="public-reference-page"><div className="public-reference-layout container mx-auto px-4 py-8 sm:px-6 md:px-10 md:py-11"><article className="public-reference-document">
    <header className="public-reference-hero"><p className="public-reference-kicker">CAM Initiative</p><h1>Copyright & Licensing</h1><p>Public access is intended to support inspection, citation, research reference and public-interest discussion. It does not make VIGIL or the CAM Governance Interface open-licensed material. The applicable rights depend on which layer you are using.</p><p className="public-reference-meta">© 2026 Phoenix Covenant Pty Ltd trading as CAM Initiative. All rights reserved.</p></header>

    <ReferenceSection number="01" eyebrow="Ownership" title="Publisher, author and licensor"><div className="public-reference-list">
      <article><div><p>Publisher / licensor</p><h3>Phoenix Covenant Pty Ltd trading as CAM Initiative</h3></div><p>Copyright ownership and licensing authority for VIGIL and the CAM Governance Interface sit with the company to the extent those rights subsist.</p></article>
    ...
    <ReferenceSection number="02" eyebrow="VIGIL" title="Publicly inspectable proprietary governance material"><div className="public-reference-reading">
      <p>The VIGIL Governance Failure Taxonomy, Incident records, taxonomy structures, families, classes, names, definitions, invariants, recognition criteria, classification boundaries, relationships, explanatory prose, schemas, indexes, structured arrangements, compilations and generated publications are proprietary VIGIL Materials where original rights are owned or controlled by CAM Initiative.</p>
      <p><strong>Citation, reference and linking are permitted and encouraged.</strong> Limited quotation is permitted to the extent allowed by applicable law. Citations should clearly attribute <strong>Dr Michelle O&apos;Rourke, CAM Initiative, VIGIL</strong> and, where relevant, identify the taxonomy version, Incident or record ID and canonical URL.</p>
      <p>Public access does not grant permission to reproduce substantial parts of VIGIL, redistribute or republish it, adapt or translate it, create derivative works, systematically extract or reconstruct the corpus, incorporate it into another taxonomy, framework, product, dataset, API or service, or otherwise make substantive commercial or non-commercial reuse without prior written permission.</p>
      <p>Use of VIGIL Materials for machine-learning training, fine-tuning, evaluation, benchmarking, retrieval or RAG systems, dataset construction, synthetic-data generation, automated classification, or AI-system development or improvement requires prior written permission.</p>
    ...
    <ReferenceSection number="03" eyebrow="Website interface" title="CAM Governance Interface Licence v1.0"><div className="public-reference-reading">
      ...
      <p>Using the Interface does not grant broader rights in the VIGIL, CAM, CAELESTIS or third-party materials displayed through it. Where a more specific notice applies to an underlying governance material, that specific notice controls.</p>
    ...
    <ReferenceSection number="04" eyebrow="Third-party sources" title="Source material keeps its own rights"><div className="public-reference-reading">
      <p>VIGIL references third-party articles, papers, standards, government publications, provider material, screenshots, platform outputs and other evidence. Those materials remain subject to the rights and licence terms of their respective owners.</p>
      <p>A VIGIL citation or evidence link does not transfer third-party rights to CAM Initiative and does not grant permission to reproduce the underlying source.</p>
    </div></ReferenceSection>
    ...
    <ReferenceSection number="05" eyebrow="Permissions" title="Licensing enquiries"><div className="public-reference-reading">
      ...
      <p><a href="https://github.com/CAM-Initiative/Vigil/blob/main/LICENSE.md" target="_blank" rel="noreferrer">Read the VIGIL Proprietary Licence →</a></p>
    </div></ReferenceSection>
